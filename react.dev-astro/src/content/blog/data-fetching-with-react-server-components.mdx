...
---
// other use autoimport in astro.config.mjs
import Intro from "@components/Intro.astro"; // below blank line is necessary
...
<Note>React Server Components are still in research and development.</Note> We are sharing this work in the spirit of transparency and to get initial feedback from the React community. There will be plenty of time for that, so **don't feel like you have to catch up right now!**
